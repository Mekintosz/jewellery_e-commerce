  ...
  return (
    <div className={styles.page}>
      <header className={styles['page__header']}>
        ...
        <p className={styles['page__subtitle']}>Enjoy tailored recommendations and expedited checkout.</p>
      </header>
      {isCreated ? (
        <Alert
          variant="success"
      ...
      <form className={styles['page__form']} onSubmit={handleSubmit}>
        ...
        <Input label="Password" name="password" id="password" type="password" required minLength={8} />
        <Input
