...
export const CartSummary = () => {
  ...
  const handleApply = () => {
    const couponData = MOCK_COUPONS[code.toUpperCase() as keyof typeof MOCK_COUPONS];
    if (!couponData) {
  ...
  return (
    <section className={styles.summary}>
      ...
      {coupon ? <p className={styles['summary__applied']}>Applied coupon: {coupon.code}</p> : null}
    </section>
  );
};
